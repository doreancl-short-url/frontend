const Sidebar = () => {
  return (
    <>
      <div className="flex">
        <div className="hidden fixed inset-0 z-20 transition-opacity bg-black opacity-50 lg:hidden"/>
        <div
          className="-translate-x-full ease-in fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto
          ...
          <div className="flex items-center justify-center mt-8">
            <div className="flex items-center">
              ...
              <span className="mx-2 text-2xl font-semibold text-white">V-Dashboard</span></div>
          </div>
          <nav className="mt-10"><a href="/dashboard"
            ...
            <span className="mx-4">Dashboard</span></a><a href="/ui-elements"
            ...
            <span className="mx-4">UI Elements</span></a><a href="/tables"
                                                            className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4 border-gray-900 text-gray-500 hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-100">
            <svg className="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            <span className="mx-4">Tables</span></a><a href="/forms"
                                                       className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4 border-gray-900 text-gray-500 hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-100">
            ...
            <span className="mx-4">Forms</span></a><a href="/cards"
                                                      className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4 border-gray-900 text-gray-500 hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-100">
            ...
            <span className="mx-4">Cards</span></a><a href="/modal"
                                                      className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4 border-gray-900 text-gray-500 hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-100">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span className="mx-4">Modal</span></a><a href="/blank"
                                                      className="flex items-center px-6 py-2 mt-4 duration-200 border-l-4 border-gray-900 text-gray-500 hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-100">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path
                d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"/>
            </svg>
            <span className="mx-4">Blank</span></a></nav>
        </div>
      </div>
    </>
  )
